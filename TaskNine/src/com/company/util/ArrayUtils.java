...
public class ArrayUtils {
    ...
    */
    ...
    public static List<Integer> readIntArrayListFromFile(String fileName) {
        int[] arr1 = ArrayUtils.readIntArrayFromFile(fileName);
        List<Integer> intList = new ArrayList<>(arr1.length);
        for (int i : arr1) {
            intList.add(i);
        }
        return intList;
